...
export const weatherIcons = {
 ...
 export type weatherIconsKeyProps = keyof typeof weatherIcons; //typeof fala que não está interesado no conteúdo e sim no 
                                                        //keyof+typeof retorna a chave do objeto
